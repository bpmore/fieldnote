...
Medium, Blogger, Notion, WriteFreely / Write.as, DEV, and Hashnode — plus
...
Settings → "Rotate themes on a schedule". The public site then cycles
through a set of themes on its own — daily or weekly, your pick — instead of
