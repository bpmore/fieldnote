...
<article class="post">
    <header class="post-header">
        ...
        <p class="post-meta"><span aria-hidden="true">&#10016;</span> <?= e($post['author']) ?> &middot; <?= e(date(i18n('dateformat', false), (int) $post['date'])) ?> <span aria-hidden="true">&#10016;</span></p>
    </header>
...
<div class="post-footer">
    <a class="back-link" href="<?= e($router->generate('home')) ?>">&larr; Return to the nave</a>
</div>
