...
<article class="post">
    <header class="post-header">
        ...
        <p class="post-meta">Gathered by <?= e($post['author']) ?> &middot; <?= e(date(i18n('dateformat', false), (int) $post['date'])) ?></p>
    </header>
...
<div class="post-footer">
    <a class="back-link" href="<?= e($router->generate('home')) ?>">&larr; Back to the meadow</a>
</div>
