...
<?php if (empty($allPosts)): ?>
    <p class="empty-state">POW! Nothing here yet &mdash; check back soon.</p>
<?php else: ?>
    <div class="panels">
        <?php foreach ($allPosts as $p): ?>
            <article class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?php if (!empty($p['password'])): ?>
                        <p class="panel-meta">Top secret &middot; <?= e(date($dateFormat, (int) $p['date'])) ?></p>
                    <?php else: ?>
                        <p class="panel-meta">By <?= e($p['author']) ?> &middot; <?= e(date($dateFormat, (int) $p['date'])) ?></p>
                    <?php endif; ?>
                </div>
            </article>
        <?php endforeach; ?>
