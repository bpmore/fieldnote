...
// This file is loaded through Composer's "files" autoload, which runs inside
// a function scope — without this declaration the table would be a local
// variable there and i18n()'s `global $language` would always come up empty.
global $language;
...
$language = [
    "en_US" => [
        ...
        "settings_default_author" => "Default Author:",
        "settings_default_author_placeholder" => "Pre-fills the author field on new posts",
    ...
    "fr_FR" => [
        ...
        "settings_default_author" => "Auteur par défaut:",
        "settings_default_author_placeholder" => "Pré-remplit le champ auteur des nouveaux articles",
    ...
    "uk_UA" => [
        ...
        "settings_default_author" => "Автор за замовчуванням:",
        "settings_default_author_placeholder" => "Автоматично заповнює поле автора для нових дописів",
